...
public class JsonResultUtils {
     ...
     * @return: 返回json
     */
    public static String failed(Integer code, Object obj){
        Map map = new HashMap();
        if (code==null){
            return failed(obj);
        }else {
    ...
    public static String jsonFormat(Object obj){
        return JSON.toJSONString(obj, SerializerFeature.WriteNonStringKeyAsString, SerializerFeature.WriteNullListAsEmpty,
     ...
     * @return
     */
    public static boolean jsonResultDataValidation(String jsonResult){
        if (StringUtils.isEmpty(jsonResult)){
            throw  new IllegalArgumentException("接收json数据为空!");
        }
