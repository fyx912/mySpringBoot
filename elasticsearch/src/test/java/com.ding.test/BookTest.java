...
public class BookTest {
    ...
    public void add(){
        ...
        list.add(new Book("5","局外人","唐松,陈智铨",5,31520005," 科技 > 计算机/网络 > 程序设计" ,"机械工业出版社","2017-09-01"));
        list.add(new Book("6","百年孤独 马尔克斯代表作","加西亚·马尔克斯",5,31520005,"文艺 > 小说 > 世界名著" ,"机械工业出版社","2017-09-01"));
        list.add(new Book("7","黑名单上的守护者","唐松,陈智铨",5,31520005," 科技 > 计算机/网络 > 程序设计" ,"机械工业出版社","2017-09-01"));
        list.add(new Book("8","余罪：我的刑侦笔记(1-8册)","常书欣",5,31520005," 科技 > 计算机/网络 > 程序设计" ,"机械工业出版社","2017-09-01"));
        list.add(new Book("9","小李飞刀(套装共9册)","古龙",5,31520005," 科技 > 计算机/网络 > 程序设计" ,"文汇出版社","2017-09-01"));
